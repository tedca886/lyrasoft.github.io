...
namespace Quickcontent\Listener\Pro;
...
class ProListener extends \JEvent
{
	...
	public function onToolbarAppendButton($context, $args = array())
	{
		...
		switch($context){
			case 'preferences' :
				...
				$args[] = 'administrator/components/com_quickcontent/includes/plugins/pro' ;
				break;
		}
		*/
	}
	...
	/**
	 * Quickcontent prepare content method
	...
	/**
	 * Quickcontent after display title method
	...
	/**
	 * Quickcontent before display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Quickcontent after display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Quickcontent before save content method
	...
	/**
	 * Quickcontent after save content method
	...
	/**
	 * Quickcontent before delete method.
	 *
	...
	/**
	 * Quickcontent after delete method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
	 * @param   object $data    The data relating to the content that is to be deleted.
	 *
	...
	/**
	 * Quickcontent on change state method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
