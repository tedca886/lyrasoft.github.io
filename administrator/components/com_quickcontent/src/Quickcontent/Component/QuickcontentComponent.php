...
namespace Quickcontent\Component;

use Quickcontent\Provider\QuickcontentProvider;
 ...
 * @since 1.0
 */
abstract class QuickcontentComponent extends Component
{
	/**
